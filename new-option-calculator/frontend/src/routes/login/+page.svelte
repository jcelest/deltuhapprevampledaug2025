...
<div class="flex min-h-full flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
  ...
  <div class="w-full max-w-3xl space-y-12">
    ...
    <!-- Increased padding and spacing inside the form -->
    <form class="space-y-12 bg-gray-800 p-16 rounded-2xl shadow-2xl border border-gray-700" on:submit|preventDefault={handleSubmit}>
